...
natasha.pen = rg.Pen('blue', 20)  # Second argument is the Pen's thickness
...
natasha.go_to(rg.Point(300, -250))


victor = rg.SimpleTurtle('turtle')
victor.pen = rg.Pen('green', 10)
victor.speed = 3

victor.backward(100)
victor.right(120)
victor.forward(240)
victor.draw_circle(40)
# I'm not entirely sure what the natasha.write_text() command does, and I was curious how you would use it
